...
func newPostTableImpl(schemaName, tableName, alias string) postTable {
	var (
		...
		allColumns      = postgres.ColumnList{IDColumn, TitleColumn, CreatedAtColumn, UpdatedAtColumn, AuthorIdColumn}
		mutableColumns  = postgres.ColumnList{TitleColumn, CreatedAtColumn, UpdatedAtColumn, AuthorIdColumn}
	)
